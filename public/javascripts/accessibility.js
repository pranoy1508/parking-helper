    ...
    function (b, e) {
      ...
      return {
        addClass: function (b, m) {
          b.classList
            ? b.classList.add(m)
            : 0 > b.className.indexOf(m) && (b.className += m);
        },
        ...
        reverseChildNodes: function (b) {
          for (var m = b.childNodes.length; m--; )
            b.appendChild(b.childNodes[m]);
        },
        ...
        scrollToPoint: function (c) {
          ...
          if ((f = d && d.scrollbar) && g(f.to) && g(f.from)) {
            ...
            if (g(d.dataMin) && g(d.dataMax)) {
              ...
              c =
                (d.toPixels(c["xAxis" === d.coll ? "x" : "y"] || 0) - l) /
                (p - l);
            } else c = 0;
      ...
      m.prototype = {
        ...
        createProxyButton: function (a, c, b, g, p) {
          ...
          a.hasClass("highcharts-no-tooltip") &&
            (y.className += " highcharts-no-tooltip");
    ...
    function (b, e, q, n, r) {
      ...
      w.prototype = {
        ...
        updateExitAnchor: function () {
          ...
          this.removeExitAnchor();
          c
            ? (this.makeElementAnExitAnchor(c), (this.exitAnchor = c))
        ...
        updateContainerTabindex: function () {
          ...
          a.renderTo.hasAttribute("tabindex") &&
            (b.removeAttribute("tabindex"), (b = a.renderTo));
          this.tabindexContainer = b;
          var f = b.getAttribute("tabindex");
          c && !f
            ? b.setAttribute("tabindex", "0")
            : c || a.container.removeAttribute("tabindex");
        },
        ...
        addExitAnchorEventsToEl: function (c) {
          ...
          this.eventProvider.addEvent(c, "focus", function (c) {
            c = c || l.event;
            (c.relatedTarget && a.container.contains(c.relatedTarget)) ||
            b.exiting
              ? (b.exiting = !1)
      ...
      b(e.prototype, {
        ...
        updateLegendItemProxyVisibility: function () {
          ...
          (a.allItems || []).forEach(function (d) {
            ...
            d.a11yProxyElement &&
              (d.a11yProxyElement.style.visibility = t ? "hidden" : "visible");
          });
        },
        onChartRender: function () {
        ...
        updateLegendTitle: function () {
          ...
          a = a.langFormat(
            ...
            { chart: a, legendTitle: c, chartTitle: v(a) }
          );
    ...
    function (b, e, q, n, r, x) {
      ...
      b.prototype.highlightLastExportItem = function () {
        ...
        if (this.exportDivElements)
          for (c = this.exportDivElements.length; c--; )
      ...
      e(b.prototype, {
          ...
          b &&
            ...
            ((this.exportProxyGroup = this.addProxyGroup(
              "all" === a.landmarkVerbosity
                ? {
                    "aria-label": c.langFormat(
                      "accessibility.exporting.exportRegionLabel",
                      { chart: c, chartTitle: l(c) }
                    ),
                    role: "region",
                  }
                : {}
        ...
        addAccessibleContextMenuAttribs: function () {
          ...
          a &&
            ...
            a.setAttribute(
              "aria-label",
              c.langFormat("accessibility.exporting.chartMenuLabel", {
                chart: c,
              })
            ));
        },
        ...
        onKbdNext: function (c) {
          ...
          c = c.response;
          for (
            var f = (a.highlightedExportItemIx || 0) + 1;
            f < a.exportDivElements.length;
            ++f
          )
            if (a.highlightExportItem(f)) return c.success;
          return b.keyboardNavigation.wrapAround
            ? (a.highlightExportItem(0), c.success)
            : c.next;
        },
    ...
    function (b, e, q, n, r, x, m, l, k) {
      ...
      b.prototype.highlightAdjacentSeries = function (c) {
        ...
        if (g(d))
          return (
            f.highlight(),
            (c = this.highlightAdjacentSeries(c)),
            c ? c : (b.highlight(), !1)
          );
        f.highlight();
  ...
  v(
    ...
    function (b, e, q, n, r) {
      ...
      function a(a) {
        ...
        if ((c = c.xAxis && c.xAxis.dateTime))
          return (
            (c = c.getXDateFormat(
              a.x || 0,
              b.options.tooltip.dateTimeLabelFormats
            )),
      ...
      function C(a) {
        ...
        b = f.length
          ? b.langFormat("accessibility.series.pointAnnotationsDescription", g)
          : "";
            ...
            b &&
              ...
              c && !h
                ? ((d = a.series),
                  ...
                  (a = F(
                    (d.pointDescriptionFormatter &&
                      d.pointDescriptionFormatter(a)) ||
      ...
      p(q.prototype, {
        ...
        buildAnnouncementMessage: function (f, g, k) {
          ...
          if (
            ...
            ((f = l.announcementFormatter(f, g, k)), !1 !== f)
          )
      ...
      e(b.prototype, {
        ...
        onChartRender: function () {
          this.chart.series.forEach(function (c) {
            !1 !==
              (c.options.accessibility && c.options.accessibility.enabled) &&
            c.visible
              ? g(c)
              : p(c);
          });
    ...
    function (b, e, q, n, r, x) {
      ...
      n(e.prototype, {
        ...
        onMapKbdTab: function (b, c) {
          ...
          b = b.response;
          var d =
            ((c = c.shiftKey) && !this.focusedMapNavButtonIx) ||
            (!c && this.focusedMapNavButtonIx);
    ...
    function (b, e, q, n, r, x, m) {
      ...
      var u = (function () {
        ...
        e.prototype.updateButtonStates = function () {
          ...
          a.buttonOptions.forEach(function (b, h) {
            ...
            J.state !== M &&
              (J.setState(M),
              c &&
                ((c.options[h + 1].disabled = A),
                2 === M && (c.selectedIndex = h + 1)),
        ...
        e.prototype.defaultInputDateParser = function (a, b, c) {
          ...
          d = Date.parse(d);
          w(d) ||
            ((a = a.split("-")), (d = Date.UTC(E(a[0]), E(a[1]) - 1, E(a[2]))));
        ...
        e.prototype.drawInput = function (a) {
          ...
          d.styledMode ||
            p.attr({ stroke: m.inputBoxBorderColor, "stroke-width": 1 });
          p.add(f);
          var u = g(
            "input",
        ...
        e.prototype.renderButtons = function () {
          ...
          this.chart.styledMode ||
            ...
            (e["stroke-width"] = z(e["stroke-width"], 0)));
          g(
            "option",
          ...
          if (f && t && l) {
            ...
            if ("top" === m)
              ...
              if (l.y === t.y) u = e;
                ...
                u = 0 > l.y || 0 > t.y ? u - Math.min(l.y, t.y) : e - b;
          ...
          var t = function (b) {
            ...
            l = function () {
              h &&
                ...
                h.attr({
                  translateX:
                    h.alignAttr.translateX + (c.axisOffset[1] >= -a ? 0 : -a),
      ...
      if (!q.RangeSelector) {
        ...
        p(e, "update", function (b) {
          ...
          c &&
            ...
            (this.rangeSelector = b = new u(this)));
    ...
    function (b, e, q, n, r, x, m, l, k, p) {
      ...
      q(e.prototype, {
        ...
        setLinkedDescriptionAttrs: function () {
          ...
          a &&
            (a.setAttribute("aria-hidden", "true"),
            L(a, "highcharts-linked-description"));
        },
    ...
    function (b, e, q, n, r, v) {
      ...
      q(n.prototype, {
        ...
        setSVGContainerLabel: function () {
          ...
          b.renderer.box &&
            c.length &&
            b.renderer.box.setAttribute("aria-label", c);
        },
        ...
        ["description", "typeDescription"].forEach(function (c) {
          ...
          e[c] &&
            ...
            m(
              ...
              !1,
              b,
              ((a = {}), (a["chart." + c] = "use accessibility." + c), a)
            ));
        });
      }
      function r(b) {
          ...
          Object.keys(k).forEach(function (c) {
            ...
            "undefined" !== typeof d &&
              ...
              m(
                ...
                !1,
                b,
                ((a = {}), (a["series." + c] = "series." + k[c].join(".")), a)
              ));
          });
        });
      }
    ...
    function (b, e, q, n) {
      function r(b, e) {
        ...
        if (-1 < k) {
          ...
          if ((e = e[a[0]]))
            for (
              k = isNaN(k) ? e.length : k,
                k = 0 > k ? e.length + k : Math.min(k, e.length),
                a = 0;
              a < k;
              ++a
            )
  ...
  v(
    ...
    function (
      ...
      F(!0, r.defaultOptions, N, {
        accessibility: { highContrastTheme: L },
        lang: I,
      });
